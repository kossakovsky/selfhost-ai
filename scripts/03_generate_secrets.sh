...
declare -A VARS_TO_GENERATE=(
    ...
    ["LINKEDGROW_AUTH_SECRET"]="hex:64" # LinkedGrow session signing secret
    ["LINKEDGROW_ENCRYPTION_KEY"]="hex:64" # LinkedGrow credential encryption (32 bytes -> 64 hex chars, validated on boot)
